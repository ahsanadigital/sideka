...
class UpdateCouncilCategoryRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'active.required' => 'Kolom status aktif atau tidaknya wajib diisi.',
            'active.boolean' => 'Kolom status aktif atau tidaknya harus berupa boolean.',
        ];
    }
}
